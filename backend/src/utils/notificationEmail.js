  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
      ...
      <p style="text-align: center;">
        <a href="https://lineless.app" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">Visit QTrack</a>
      </p>
      <hr style="margin: 20px 0; border: 0; border-top: 1px solid #ccc;">
      <p style="font-size: 0.9em; color: #777;">This is an automated email from QTrack. Please do not reply.</p>
    </div>
  `;
